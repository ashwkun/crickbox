...
const UpcomingCard: React.FC<UpcomingCardProps> = React.memo(({
    ...
    return (
        ...
        >
            ...
            {/* Background Watermarks - Hidden for TBC cards to keep it clean */}
            {!bothTeamsUndetermined && team1Name !== 'TBC' && team1Name !== 'T.B.C.' && (
            ...
            {!bothTeamsUndetermined && team2Name !== 'TBC' && team2Name !== 'T.B.C.' && (
